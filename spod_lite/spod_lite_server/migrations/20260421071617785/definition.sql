...
--
-- Class AdminSession as table admin_session
--
...
--
-- Class AppSession as table app_session
--
...
--
-- Class CollectionDef as table collection_def
--
CREATE TABLE "collection_def" (
    "id" bigserial PRIMARY KEY,
    "name" text NOT NULL,
    "label" text NOT NULL,
    "listRule" text NOT NULL DEFAULT 'admin'::text,
    "viewRule" text NOT NULL DEFAULT 'admin'::text,
    "createRule" text NOT NULL DEFAULT 'admin'::text,
    "updateRule" text NOT NULL DEFAULT 'admin'::text,
    "deleteRule" text NOT NULL DEFAULT 'admin'::text,
    "createdAt" timestamp without time zone DEFAULT CURRENT_TIMESTAMP
);
...
--
-- Class CollectionField as table collection_field
--
...
--
-- Class OAuthProviderConfig as table oauth_provider_config
--
...
--
-- Class UserOAuthLink as table user_oauth_link
--
